...
const AdminManagement: React.FC = () => {
  ...
  const users = [
    { id: '1', name: 'Meareg Teame', email: 'meareg@tech.corp', role: 'student', year: 'Expert', progress: '85%' },
    { id: '2', name: 'Abebe Bikila', email: 'abebe@tech.corp', role: 'student', year: 'Intermediate', progress: '42%' },
    { id: '3', name: 'Sara Kebede', email: 'sara@tech.corp', role: 'admin', year: 'Mentor', progress: '100%' },
    { id: '4', name: 'Dawit Mekonnen', email: 'dawit@tech.corp', role: 'student', year: 'Advanced', progress: '72%' },
  ];
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-slate-50 dark:bg-slate-800/50">
                  ...
                  <th className="px-10 py-6 text-[10px] font-black uppercase tracking-widest text-slate-400">Level</th>
                  <th className="px-10 py-6 text-[10px] font-black uppercase tracking-widest text-slate-400">Role</th>
                  <th className="px-10 py-6 text-[10px] font-black uppercase tracking-widest text-slate-400">Progress</th>
                  <th className="px-10 py-6 text-[10px] font-black uppercase tracking-widest text-slate-400 text-right">Edit</th>
                </tr>
              </thead>
